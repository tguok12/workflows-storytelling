...
if __name__ == "__main__":
    ...
    try:
        ...
        print("ERROR: this file requires specific arguments to run\n", getopt.GetoptError)
    ...
    if not db_file:
        raise Exception("you need to provide the db file name")
    if not streams_file:
        raise Exception("you need to provide the streams name")
    ...
    if not os.path.exists(streams_file) or not os.path.exists(db_file):
        print("... streams_file", streams_file, os.path.exists(streams_file))
        print("... db path", db_file, os.path.exists(db_file))
        raise Exception("either the streams file or the db path is invalid")
